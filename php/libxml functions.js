window.phpIntellisense.libxmlFunctions = [
    window.cmSnip(`libxml_clear_errors();$\{}`, {
        label: "libxml_clear_errors()",
        detail: "LibXML",
        type: "method",
        info: `The libxml_clear_errors() function clears the libxml error buffer.`
    }),
    window.cmSnip(`libxml_disable_entity_loader();$\{}`, {
    ...
    window.cmSnip(`libxml_set_streams_context($\{});$\{}`, {
    ...
    window.cmSnip(`libxml_use_internal_errors($\{});$\{}`, {
